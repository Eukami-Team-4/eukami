    ...
    return (
        <div className="container p-4 mx-auto bg-white">
            <div className="flex items-center justify-between p-4 bg-white">
                <input type = "text" placeholder="Type a command for search" className="w-full p-2 border border-gray-300 rounded-log"/>
                <button className="px-4 py-2 text-white bg-black rounded-md">Search</button>
            </div>
