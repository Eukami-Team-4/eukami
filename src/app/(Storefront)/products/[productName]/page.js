...
const ProductInfo = ({ product }) => {
  ...
  function addToCart(){
    toast("This will add a product to the cart in the future")
  }
  return (
      ...
      <div className="flex flex-col justify-center flex-1 gap-3">
        ...
        <div className="flex gap-3">
          ...
          <div className="flex gap-6">
            <StorefrontButton onClick={addToCart}>Add To Cart</StorefrontButton>
          </div>
        </div>
      </div>
    </section>
...
const QuantitySelector = ({ quantity, setQuantity, className }) => {
  return (
          ...
          {Array(4)
            ...
            .map((v, i) => (
              <li key={i} className="flex items-center">
                <CheckCircle2 size={16} className="mr-2 text-brightOrange" />{" "}
                Headphone Unit
              </li>
            ))}
        </ul>
