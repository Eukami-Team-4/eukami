  ...
  return (
    <main className="bg-white">
      ...
      <main className="container p-8 py-16 mx-auto space-y-32">
        <section className="flex text-gray-600">
        ...
        <section className="space-y-12">
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-3">
            <div className="relative flex flex-col items-center justify-center gap-3 p-6 h-72">
              <img
              ...
              <button className="flex items-center gap-1 text-sm text-gray-500 uppercase">
                Shop
                <svg
              ...
              <div className="absolute bottom-0 w-full rounded-md bg-muted h-3/5 -z-10"></div>
            </div>
            <div className="relative flex flex-col items-center justify-center gap-3 p-6 h-72">
              <img
                className="object-contain w-32 rounded-md"
              ...
              <div className="absolute bottom-0 w-full rounded-md bg-stone-200 h-3/5 -z-10"></div>
            </div>
            <div className="relative flex flex-col items-center justify-center gap-3 p-6 h-72">
              <img
                className="object-contain w-32 rounded-md"
              ...
              <div className="absolute bottom-0 w-full rounded-md bg-stone-200 h-3/5 -z-10">
                somethings in here
              </div>
            </div>
          </div>
        ...
        <section className="grid-cols-2 md:grid gap-x-32">
          <div className="flex flex-col items-center justify-center ml-auto max-w-96">
            <h3 className="text-2xl uppercase">
              Bringing you the <span className="text-amber-500">best</span>{" "}
              audio gear
            </h3>
      ...
      <footer className="bg-stone-900">
        <div className="container relative grid grid-cols-2 gap-4 p-8 mx-auto text-white">
